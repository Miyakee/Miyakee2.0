...
<div id="right" >
<form action="{{action('ArticleController@getAdd')}}" method="get">
                        <div><span>标题</span>
                            <div><input type="text" class="text" name="theme"/></div>
                        </div>
                        <div><span>分类</span>
                            <div><input type="text" class="text" name="category_id"/></div>
                        </div>
						<div><span>内容</span>
                            <div><textarea  id="TextArea1"   class="text" name="content" cols="100" rows="30"></textarea>
